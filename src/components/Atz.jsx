...
export default function Atz({ drag, isPopupOpen, setIsPopupOpen }) {
 ...
 const hendelChange = (event) => {
  ...
  return (
    <motion.div dir='rtl' className='text-center bg-white flex-1 container  px-4 mt-[10px]' initial={{ opacity:0}} animate={{opacity:1}} exit={{ x:100, opacity:0, transition:{duration:0.2}}} >
