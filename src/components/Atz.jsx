      ...
      <section className='grid grid-flow-row sm:grid-cols-1 gap-8 mb-4'>
        ...
        <article className=' flex flex-col mx-auto justify-center bg-gray-200 rounded-xl shadow-lg shadow-slate-900'>
          ...
          <div className=' rounded-b-xl bg-slate-800 px-6 py-4 text-slate-300'>
            ...
            <Link className=' text-xl inline-block rounded-t rounded-b mx-auto justify-center bg-indigo-500 p-4 font-bold w-full px-1' to='https://www.ovdayzahal.org.il/'>אתר ארגון עובדי צה"ל</Link>
          </div>
        </article>
        <article className=' flex flex-col mx-auto justify-center bg-gray-200 rounded-xl shadow-lg shadow-slate-900'>
          ...
          <div className=' rounded-b-xl bg-slate-800 px-6 py-4 text-slate-300'>
            ...
            <Link className=' text-xl inline-block rounded-t rounded-b mx-auto justify-center bg-indigo-500 p-4 font-bold w-full px-1' to='https://oz.eshet.com/login'>אתר הזמנות נופש</Link>
          </div>
        </article>
      </section>
      <section className='grid grid-flow-row sm:grid-cols-1 gap-8 mb-4'>
        ...
        <article className=' flex flex-col mx-auto justify-center bg-gray-200 rounded-xl shadow-lg shadow-slate-900'>
          ...
          <div className=' rounded-b-xl bg-slate-800 px-6 py-4 text-slate-300'>
            ...
            <Link className=' text-xl inline-block rounded-t rounded-b mx-auto justify-center bg-indigo-500 p-4 font-bold w-full px-1' to='https://www.idf.il/19875'>תוספת מעונות</Link>
          </div>
        </article>
        <article className=' flex flex-col mx-auto justify-center bg-gray-200 rounded-xl shadow-lg shadow-slate-900'>
          ...
          <div className=' rounded-b-xl bg-slate-800 px-6 py-4 text-slate-300'>
            ...
            <Link className=' text-xl inline-block rounded-t rounded-b mx-auto justify-center bg-indigo-500 p-4 font-bold w-full px-1' to='https://www.idf.il/19835'>משרת הורה</Link>
          </div>
        </article>
        <article className=' flex flex-col mx-auto justify-center bg-gray-200 rounded-xl shadow-lg shadow-slate-900'>
          ...
          <div className=' rounded-b-xl bg-slate-800 px-6 py-4 text-slate-300'>
            ...
            <Link className=' text-xl inline-block rounded-t rounded-b mx-auto justify-center bg-indigo-500 p-4 font-bold w-full px-1' to='https://www.idf.il/19876'>תוספת וגמול השתלמות</Link>
          </div>
        </article>
        <article className=' flex flex-col mx-auto justify-center bg-gray-200 rounded-xl shadow-lg shadow-slate-900'>
          ...
          <div className=' rounded-b-xl bg-slate-800 px-6 py-4 text-slate-300'>
            <p className='text-slate-300 p-2'>רוצים לצאת לחו"ל בזמן השירות ? כל המידע שאתה צריכים בשביל לעשות זאת נמצא ממש כאן</p>
            <Link className=' text-xl inline-block rounded-t rounded-b mx-auto justify-center bg-indigo-500 p-4 font-bold w-full px-1' to='https://www.idf.il/19920'>חופשת משפחה</Link>
          </div>
        </article>
        <article className=' flex flex-col mx-auto justify-center bg-gray-200 rounded-xl shadow-lg shadow-slate-900'>
          ...
          <div className=' rounded-b-xl bg-slate-800 px-6 py-4 text-slate-300'>
            <p className='text-slate-300 p-2'>רוצים לצאת לחו"ל בזמן השירות ? כל המידע שאתה צריכים בשביל לעשות זאת נמצא ממש כאן</p>
            <Link className=' text-xl inline-block rounded-t rounded-b mx-auto justify-center bg-indigo-500 p-4 font-bold w-full px-1' to='https://www.idf.il/19893'>לימודים</Link>
          </div>
        </article>
        <article className=' flex flex-col mx-auto justify-center bg-gray-200 rounded-xl shadow-lg shadow-slate-900'>
          ...
          <div className=' rounded-b-xl bg-slate-800 px-6 py-4 text-slate-300'>
            <p className='text-slate-300 p-2'>רוצים לצאת לחו"ל בזמן השירות ? כל המידע שאתה צריכים בשביל לעשות זאת נמצא ממש כאן</p>
            <Link className=' text-xl inline-block rounded-t rounded-b mx-auto justify-center bg-indigo-500 p-4 font-bold w-full px-1' to='https://www.idf.il/19906'>בדיקות רפואיות</Link>
          </div>
        </article>
      </section>
      <section className='grid grid-flow-row sm:grid-cols-1 gap-8'>
          <article className=' flex flex-col mx-auto justify-center bg-gray-200 rounded-xl shadow-lg shadow-slate-900'>
            ...
            <div className=' rounded-b-xl bg-slate-800 px-6 py-4 text-slate-300'>
              ...
              <button className=' text-xl inline-block rounded-t rounded-b mx-auto justify-center bg-indigo-500 p-4 font-bold w-full px-1' onClick={()=> openPdf(file[0])}>השתלמות בשכר</button>
          ...
          <article className=' flex flex-col mx-auto justify-center bg-gray-200 rounded-xl shadow-lg shadow-slate-900'>
            ...
            <div className=' rounded-b-xl bg-slate-800 px-6 py-4 text-slate-300'>
              ...
              <button className=' text-xl inline-block rounded-t rounded-b mx-auto justify-center bg-indigo-500 p-4 font-bold w-full px-1' onClick={()=> openPdf(file[1])}>ימי מועד ובחירה</button>
              {isPopupOpen && <PopUpPdf isOpen={isPopupOpen} onClose={()=> setIsPopupOpen(false)} pdf={selectedPdf}/>}
            </div>
          </article>
          <article className=' flex flex-col mx-auto justify-center bg-gray-200 rounded-xl shadow-lg shadow-slate-900'>
            ...
            <div className=' rounded-b-xl bg-slate-800 px-6 py-4 text-slate-300'>
              <p className='text-slate-300 p-2'>מפקדים כל מה שאתם צריכים לדעת על חיילי ת"ש  זכויות </p>
              <button className=' text-xl inline-block rounded-t rounded-b mx-auto justify-center bg-indigo-500 p-4 font-bold w-full px-1' onClick={()=> openPdf(file[2])}>חופשות מרוכזות וימי גשר</button>
              {isPopupOpen && <PopUpPdf isOpen={isPopupOpen} onClose={()=> setIsPopupOpen(false)} pdf={selectedPdf}/>}
            </div>
          </article>
      </section>
