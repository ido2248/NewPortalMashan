...
export default function Mkeva() {
  ...
  return (
    <motion.div className='text-center bg-white flex-1 container mx-auto py-4 px-8 mt-[150px]' initial={{x:300, opacity:0}} animate={{ x: 0, opacity: 1 }} exit={{ x: -100, opacity: 0 ,transition:{duration:0.2}}}>
