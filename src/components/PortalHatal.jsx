...
export default function PortalHatal() {
  ...
  return (
    <motion.div className='text-center bg-slate-100 flex-1 container mx-auto py-4 px-8 mt-[120px]' initial={{ opacity:0}} animate={{ opacity: 1 }} exit={{ x: 100, opacity: 0 ,transition:{duration:0.2}}}>
      ...
      <section className='grid grid-flow-row sm:grid-cols-1 gap-8 mb-4'>
        ...
        <article className=' flex flex-col mx-auto justify-center bg-gray-200 rounded-xl shadow-lg shadow-slate-900'>
          ...
          <div className=' rounded-b-xl bg-slate-800 px-6 py-4 text-slate-300'>
            ...
            <Link className=' text-xl inline-block rounded-t rounded-b mx-auto justify-center bg-blue-600 p-4 font-bold w-full px-1' to='https://www.home.idf.il/'>צ 360</Link>
          </div>
        </article>
        <article className=' flex flex-col mx-auto justify-center bg-gray-200 rounded-xl shadow-lg shadow-slate-900'>
          ...
          <div className=' rounded-b-xl bg-slate-800 px-6 py-4 text-slate-300'>
            ...
            <Link className=' text-xl inline-block rounded-t rounded-b mx-auto justify-center bg-blue-600 p-4 font-bold w-full px-1' to='https://www.home.idf.il/'>חרבות ברזל</Link>
          </div>
        </article>
        <article className=' flex flex-col mx-auto justify-center bg-gray-200 rounded-xl shadow-lg shadow-slate-900'>
          ...
          <div className=' rounded-b-xl bg-slate-800 px-6 py-4 text-slate-300'>
            ...
            <Link className=' text-xl inline-block rounded-t rounded-b mx-auto justify-center bg-blue-600 p-4 font-bold w-full px-1' to='https://sadir.azurewebsites.net/'>סדיר</Link>
          </div>
        </article>
        <article className=' flex flex-col mx-auto justify-center bg-gray-200 rounded-xl shadow-lg shadow-slate-900'>
          ...
          <div className=' rounded-b-xl bg-slate-800 px-6 py-4 text-slate-300'>
            ...
            <Link className=' text-xl inline-block rounded-t rounded-b mx-auto justify-center bg-blue-600 p-4 font-bold w-full px-1' to='https://one.prat.idf.il/login'>דו"ח 1</Link>
          </div>
        </article>
        <article className=' flex flex-col mx-auto justify-center bg-gray-200 rounded-xl shadow-lg shadow-slate-900'>
          ...
          <div className=' rounded-b-xl bg-slate-800 px-6 py-4 text-slate-300'>
            ...
            <Link className=' text-xl inline-block rounded-t rounded-b mx-auto justify-center bg-blue-600 p-4 font-bold w-full px-1' to='https://meditik.medical.idf.il/'>MediTik</Link>
          </div>
        </article>
        <article className=' flex flex-col mx-auto justify-center bg-gray-200 rounded-xl shadow-lg shadow-slate-900'>
      ...
      <section className='grid grid-flow-row sm:grid-cols-1 gap-8 pt-8'>
        ...
        <article className=' flex flex-col mx-auto justify-center bg-gray-200 rounded-xl shadow-lg shadow-slate-900'>
          ...
          <p className='text-slate-300 p-2'>כל המידע הנדרש על הקורסים וגמולות ההשתלמות</p>
            <button className=' text-xl inline-block rounded-t rounded-b mx-auto justify-center bg-blue-600 p-4 font-bold w-full px-1' onClick={()=> openPdf(file[1])}>קורסים וגמו"ש</button>
        ...
        <article className=' flex flex-col mx-auto justify-center bg-gray-200 rounded-xl shadow-lg shadow-slate-900'>
          ...
          <div className=' rounded-b-xl bg-slate-800 px-6 py-4 text-slate-300'>
            ...
            <button className=' text-xl inline-block rounded-t rounded-b mx-auto justify-center bg-blue-600 p-4 font-bold w-full px-1' onClick={()=> openPdf(file[0])}>ת"ש</button>
            {isPopupOpen && <PopUpPdf isOpen={isPopupOpen} onClose={()=> setIsPopupOpen(false)} pdf={selectedPdf}/>}
          </div>
        </article>
      </section>
